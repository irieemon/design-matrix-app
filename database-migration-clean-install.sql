-- Clean Multi-User Authentication System Installation
-- Run this after dropping all tables for a fresh start
...
-- Create demo user for initial setup
...
CREATE TABLE public.projects (
    ...
    tags text[],
    owner_id uuid REFERENCES public.user_profiles(id) ON DELETE CASCADE NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000'::uuid,
...
CREATE TABLE public.ideas (
    ...
    created_by uuid REFERENCES public.user_profiles(id) ON DELETE SET NULL DEFAULT '00000000-0000-0000-0000-000000000000'::uuid,
    created_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL,
    updated_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL,
...
-- Projects: Users can create new projects
