...
async function getTokenSpend(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.log(`💰 Admin ${auth.email} fetching token spend analytics`)
